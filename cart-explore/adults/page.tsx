...
import DeleteLastAdultButton from "../DeleteLastAdultButton";
import DeleteFirstAdultButton from "../DeleteFirstAdultButton";
    ...
    <div className="universal-styling">
      <div className="kittens-sett">
        ...
        <div className="kitten-settings-block">
          <Link href="/add/adult">Добавить взрослого</Link>
