...
import DeleteLastKittenButton from "../../cart-explore/DeleteLastKittenButton";
    ...
    <div className="universal-styling">
      <div className="kittens-sett">
        ...
        <div className="kitten-settings-block">
          <Link href="/add/kitten">Добавить котенка</Link>
            ...
            <div key={kitten.id} className="kitten-card">
              ...
              <div className="parents-kitten">
                <div className="parent-generic">
                  ...
                  <span>Мама: {kitten.mother?.name || "Не указана"}</span>
                </div>
                ...
                <div className="parent-generic">
                  ...
                  <span>Папа: {kitten.father?.name || "Не указан"}</span>
                </div>
              </div>
            </div>
          ))}
